//input: word and text
//output: number (the number of times the word appears in the text
//
//case-insensitive
//
//split text to array of letters, joiner(' ')
//transform array with filter(letters)
//  at each iteration, return if letters.toUpperCase() === word.toUpperCase()
//return length of resulting array
//

/*
function searchWord(word, text) {
  return text.split(' ').filter(function(letters) {
    return letters.toUpperCase() === word.toUpperCase();
  }).length;
}
*/
...
console.log(searchWord('on', 'The cow jumped over the moon')); // 0
console.log(searchWord('apples', 'The cow jumped over the moon')); // 0
